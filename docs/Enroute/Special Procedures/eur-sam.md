...
- EUR-SAM refers to a defined airspace corridor that links Europe (via the Iberian Peninsula and the Canary Islands) to South America (namely, Brazil, Uruguay, and Argentina).
- It crosses the LPPC, GCCC, DGAA, GMMM, GOOO, GVSC, GOOO Oceanic, SBAO, SBRE, SBCW, SUEO, and SAEF FIRs.
- An official map of the EUR-SAM corridor can be viewed [here](http://www.satmasat.com/files/eur_sam/sat.pdf).
...
- RVSM and RNP 10 are applied between FL290 and FL410.
