...
*Pilots taking part in events that depart from or arrive at DNMM should make themselves familiar with this briefing page as well as with all existing charts.*

## Overview

- Lagos Murtala Mohammed Airport is an international airport located in Ikeja, Lagos State, Nigeria, and is the major airport serving the entire state.

- The airport has 2 parallel runways 18R and 18L.
...
- DNMM does not have a real world Delivery position but one has been created on VATSIM, particularly for busy events. If offline, contact Ground for Delivery Clearance.
...
- **You may be transferred from Tower directly to Accra Control.**
...
- **DNMM is Code F compliant.**
  
- **Code F aircraft should avoid taxiway C.**
  
- **Code F aircraft should park at the International Terminal.**
...
- As your flight is approaching DNMM, please make yourself familiar with the arrival and approach procedures for Lagos.

- All pilots expect Runway 18L or 18R for landing. For Cross Africa, we'll be using Runway 18R to land, expect the **ILS.**
